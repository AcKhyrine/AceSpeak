...
class LessonScore1 extends StatefulWidget {
  final String userId;
  final String grade;
  final String lesson;
  int index;
  ...
  @override
  _LessonScore1State createState() => _LessonScore1State();
}

class _LessonScore1State extends State<LessonScore1> {
