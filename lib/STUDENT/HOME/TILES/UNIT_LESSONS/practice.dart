import 'package:acespeak/STUDENT/HOME/TILES/UNIT_LESSONS/recording.dart';
...
class PracticeScreen1 extends StatefulWidget {
  ...
  final String words;
  final String item;
  PracticeScreen1({super.key,required this.userId, required this.item, required this.words, required this.grade, required this.lesson, required this.index, required this.number});
