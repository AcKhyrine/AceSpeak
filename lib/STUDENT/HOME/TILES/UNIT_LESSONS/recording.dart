import 'dart:convert';
import 'dart:io';
import 'package:acespeak/STUDENT/HOME/TILES/UNIT_LESSONS/score.dart';
...
class Recording1 extends StatefulWidget {
  ...
  @override
  _Recording1State createState() => _Recording1State();
}

class _Recording1State extends State<Recording1> {
  ...
  void Dialog()async{
    int addvalue = widget.index +=1 ;
     ...
     Navigator.push(context, MaterialPageRoute(builder: ((context) {
            return LessonScore1(score : resultController.text,  spell:spell, overall: overall, phonic:phonic, userId: widget.userId, grade: widget.grade, lesson: widget.lesson, index: addvalue, number: widget.number, item: widget.item);
          })));
