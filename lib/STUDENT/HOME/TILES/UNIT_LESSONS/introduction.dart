...
class LessonIntro1 extends StatefulWidget {
  final String userId;
  final String grade;
  final String lesson;
  final int index;
  final int number;
  final String item;
  const LessonIntro1({super.key, required this.userId, required this.item, required this.grade, required this.lesson, required this.index, required this.number});

  @override
  State<LessonIntro1> createState() => _LessonIntro1State();
}

class _LessonIntro1State extends State<LessonIntro1> {
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (ctx){
                            return Lesson_Screen1(userId: widget.userId, grade: widget.grade, lesson: widget.lesson, index: widget.index, number: widget.number, item: widget.item,);
                          }));
                          print('.............................................lesson screen');
                        },
                        child: Text('Start'),
