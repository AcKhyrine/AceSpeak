...
class Post_Assessment_Score1 extends StatefulWidget {
  final String userId;
  final String grade;
  final String lesson;
  final int average;
  ...
  @override
  _Post_Assessment_Score1State createState() => _Post_Assessment_Score1State();
}

class _Post_Assessment_Score1State extends State<Post_Assessment_Score1> {
