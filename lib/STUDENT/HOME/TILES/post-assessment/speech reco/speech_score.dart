...
class SpeechPost_Assessment_Score1 extends StatefulWidget {
  final String userId;
  final String grade;
  final String lesson;
  final String docId;
  final String pre_assessment;
  const SpeechPost_Assessment_Score1({
    Key? key,
  ...
  @override
  _SpeechPost_Assessment_Score1State createState() => _SpeechPost_Assessment_Score1State();
}

class _SpeechPost_Assessment_Score1State extends State<SpeechPost_Assessment_Score1> {
