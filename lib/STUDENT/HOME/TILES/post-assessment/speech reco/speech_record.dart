...
class SpeechAssessmentRecord1 extends StatefulWidget {
  ...
  @override
  _SpeechAssessmentRecord1State createState() => _SpeechAssessmentRecord1State();
}

class _SpeechAssessmentRecord1State extends State<SpeechAssessmentRecord1> {
