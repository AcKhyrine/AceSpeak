import 'dart:convert';
import 'dart:io';
import 'package:acespeak/STUDENT/MAIN%20FEATURE/LESSONS/score.dart';
...
class Recording extends StatefulWidget {
  ...
  Recording({
    ...
    required this.userId,required this.classroomID, required this.item, required this.words, required this.grade, required this.lesson, required this.index, required this.number
  }) : super(key: key);
  ...
  void Dialog()async{
    int addvalue = widget.index +=1 ;
     ...
     Navigator.push(context, MaterialPageRoute(builder: ((context) {
            return LessonScore(score : resultController.text,  spell:spell, overall: overall, phonic:phonic, userId: widget.userId, grade: widget.grade, lesson: widget.lesson, index: addvalue, number: widget.number, item: widget.item, classroomID : widget.classroomID);
          })));
