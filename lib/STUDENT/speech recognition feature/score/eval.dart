...
class _EvalScreenState extends State<EvalScreen> {
  ...
  final audioUrl =
      "https://firebasestorage.googleapis.com/v0/b/casptone-14c19.appspot.com/o/upload-voice-firebase%2F1690690872278.wav?alt=media&token=15ad9fd3-ce4d-46a3-a6c0-ec97b84cd2e1"; // Replace with the audio URL.
  final audioType =
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [Text(resultController.text)],
        ),
      ),
    );
  }
          ...
          response.stream.transform(utf8.decoder).join().then((String str) {
            if (str.contains("error")) {
              ...
              resultController.text =
                  "overall: ${respJson["result"]["pronunciation"]}";
            }
          });
        }
      } else {
